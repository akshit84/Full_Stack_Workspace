...
import { AddToCartContext } from './DashBoard';


function DisplayList({ category, products }) {

    const { cartCount, setcartCount } = useContext(AddToCartContext)
        ...
        <>
            <div className='p-5'>
                ...
                <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mt-4'>
                    ...
                    {products.map((item) => (
                        <div key={item.id} className='border-2 border-gray-700 rounded-xl gap-4 h-[270px] w-[300px]'>
                            ...
                            <div className='flex justify-between'>
                                ...
                                <button onClick={handleCartCount} className='mr-3 bg-slate-900 rounded-xl text-white w-auto px-2 font-semibold'>Add to Cart</button>
